		...
		<div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50">
			...
			>
				...
				<div className="flex justify-center items-center flex-grow-0 flex-shrink-0 gap-4">
					<div
						className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[120px] h-12 relative px-6 py-3 rounded-lg bg-[#d9d9d9] cursor-pointer"
						onClick={onClose}
					>
						<p className="flex-grow-0 flex-shrink-0 text-xl font-semibold text-left text-neutral-700">닫기</p>
					</div>
					<div
						className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-60 h-12 relative px-6 py-3 rounded-lg bg-[#58b9c1] cursor-pointer"
