...
// 반복되는 체크 아이콘
const CheckIcon = () => (
	<svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 md:w-10 md:h-10 lg:w-[46px] flex-shrink-0">
		<path d="M45.3462 10.5664L19.5423 33.1565L9.86165 17.1456L13.141 15.1615L20.4576 27.2605L42.8231 7.68392L45.3462 10.5664Z" fill="white"></path>
	</svg>
);
			...
			<div className="w-full relative bg-[#efefef] overflow-hidden">
				...
				<div className="relative flex flex-col lg:flex-row items-center justify-center w-full max-w-[1536px] mx-auto px-4 sm:px-8 py-12 md:py-24 gap-8">
					...
					<div className="w-full lg:w-3/5 relative" style={{minHeight: '500px'}}>
						<div className="absolute left-[5%] sm:left-[10%] top-[5%] lg:top-[1%] w-auto z-20" style={{ filter: 'drop-shadow(0px 0px 20px rgba(0,0,0,0.2))' }}>
							<div className="flex justify-center items-center h-auto relative gap-2.5 px-6 py-3 rounded-2xl bg-white">
								<p className="text-2xl md:text-3xl lg:text-[40px] font-light text-left text-[#4d4d4d]">내 주변 센터</p>
							</div>
					...
					<div className="w-full lg:w-2/5 flex flex-col justify-start items-start gap-4 md:gap-6">
						<div className="flex justify-start items-center w-full relative gap-4 px-4 py-3 md:px-8 md:py-4 rounded-2xl bg-[#108389]"><CheckIcon /><p className="text-xl md:text-3xl lg:text-[42px] font-bold text-left text-white">지도 기반 탐색</p></div>
						<div className="flex justify-start items-center w-full relative gap-4 px-4 py-3 md:px-8 md:py-4 rounded-2xl bg-[#15afb7]"><CheckIcon /><p className="text-xl md:text-3xl lg:text-[42px] font-bold text-left text-white">간편한 위치 검색</p></div>
						<div className="flex justify-start items-center w-full relative gap-4 px-4 py-3 md:px-8 md:py-4 rounded-2xl bg-[#108389]"><CheckIcon /><p className="text-xl md:text-3xl lg:text-[42px] font-bold text-left text-white">실시간 요금 확인</p></div>
						<div className="flex justify-start items-center w-full relative gap-4 px-4 py-3 md:px-8 md:py-4 rounded-2xl bg-[#15afb7]"><CheckIcon /><p className="text-xl md:text-3xl lg:text-[42px] font-bold text-left text-white">내 주변 센터 찾기</p></div>
						<div className="flex justify-start items-center w-full relative gap-4 px-4 py-3 md:px-8 md:py-4 rounded-2xl bg-[#108389]"><CheckIcon /><p className="text-xl md:text-3xl lg:text-[42px] font-bold text-left text-white">쉽고 빠른 가격비교</p></div>
					</div>
				</div>
			</div>
		</div>
