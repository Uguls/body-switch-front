		...
		<div className="pt-20 md:pt-24 flex flex-col items-center w-full">
			...
			<div className="relative w-full flex justify-center items-center py-8 md:py-16">
				<div className="relative flex items-center justify-center w-full max-w-6xl">
					...
					<div className="relative z-30">
						<img
							src="/src/assets/images/about/about-us-top-solution.jpg"
							alt="Solution"
					...
					<div className="relative z-20 -ml-8 md:-ml-12 lg:-ml-16 -mr-8 md:-mr-12 lg:-mr-16">
						<img
							src="/src/assets/images/about/about-us-top-automation.jpg"
							alt="Automation"
							className="w-48 md:w-64 lg:w-80 h-auto"
						/>
					</div>
					...
					<div className="relative z-10">
						<img
							src="/src/assets/images/about/about-us-top-marketing.jpg"
							alt="Marketing"
							className="w-48 md:w-64 lg:w-80 h-auto"
						/>
					</div>
			...
			<div className="flex flex-col w-full min-h-screen lg:min-h-[1600px] bg-[#1a1a1a] px-4 md:px-12 lg:px-16 xl:px-24 2xl:px-32 py-8">
				...
				<div className="flex justify-center items-center gap-6 mb-8 lg:hidden">
					<img
						src="/src/assets/images/about/about-us-operator.jpg"
						alt="운영자"
						className="w-28 h-28 sm:w-32 sm:h-32"
					/>
					<img
						src="/src/assets/images/about/about-us-user.jpg"
						alt="사용자"
						className="w-28 h-28 sm:w-32 sm:h-32"
					/>
					<img
						src="/src/assets/images/about/about-us-instructor.jpg"
						alt="강사"
						className="w-28 h-28 sm:w-32 sm:h-32"
					/>
				</div>
				...
				{/* 데스크톱 레이아웃 */}
				<div className="hidden lg:flex justify-center items-center w-full max-w-7xl mx-auto">
					...
					{/* 우측 - 텍스트 (데스크톱) */}
					<div className="flex-1 ml-8 xl:ml-12 2xl:ml-16 max-w-4xl">
						<div className="text-left space-y-6">
							<h2 className="text-5xl font-medium text-[#4ab3bc] mb-8">
								최적의 경험을 위한 통합 솔루션
							</h2>
							
							<p className="text-[32px] font-semibold text-white leading-relaxed">
								바디스위치는 사용자와 강사,<br />
