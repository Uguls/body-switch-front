					...
					<div className="flex flex-col lg:flex-row justify-start items-start gap-16">
						...
						<div className="flex flex-col gap-2">
							...
							<div className="flex items-center gap-4">
								<div 
									className="flex flex-col justify-center items-center h-[220px] w-[200px] gap-3 rounded-lg bg-white border border-[#d9d9d9] cursor-pointer hover:bg-gray-50 transition-colors relative"
